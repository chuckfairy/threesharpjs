...
G3.Whammy = function() {
	...
	var toWebM = function(frames, outputAsArray){
	...
	var checkFrames = function(frames){
	...
	var generateEBML = function(json, outputAsArray){
		var ebml = [];
	...
	var toBinStr_old = function(bits){
		var data = '';
	...
	var generateEBML_old = function(json){
		var ebml = '';
		for(var i = 0; i < json.length; i++){
			var data = json[i].data;
	...
	var WhammyVideo = function(speed, quality){ // a more abstract-ish API
		this.frames = [];
